...
* Privacy and Accuracy-Aware AI/ML Model Deduplication
  ...
  * Authors: Hong Guan, Lixi Zhou, Lei Yu, Li Xiong, Kanchan Chowdhury, Lulu Xie, Xusheng Xiao, Jia Zou
  * Publication Link: [Here](https://dl.acm.org/doi/abs/10.1145/3725340)
...
* ExBoost: Out-of-Box Co-Optimization of Machine Learning and Join Queries
  ...
  * Authors: Kanchan Chowdhury, Lulu Xie, Lixi Zhou, Jia Zou
  * Preprint Link: [Here](https://kanchanchy.github.io/files/ExBoost_DASFAA_2025.pdf)

* Declarative Privacy-Preserving Inference Queries
  * Published in the 30th International Conference on Database Systems for Advanced Applications (DASFAA) 2025
  * Authors: Hong Guan, Ansh Tiwari, Summer Gautier, Rajan Hari Ambrish, Lixi Zhou, Deepti Gupta, Yancheng Wang, Yingzhen Yang, Chaowei Xiao, Kanchan Chowdhury, Jia Zou
  * Preprint Link: [Here](https://arxiv.org/abs/2401.12393)
...
* Deep Learning with Spatiotemporal Data: A Deep Dive into GeotorchAI
  ...
  * Authors: Kanchan Chowdhury, Mohamed Sarwat
  * Publication Link: [Here](https://ieeexplore.ieee.org/abstract/document/10598177)
...
* A Machine Learning-Aware Data Re-partitioning Framework for Spatial Datasets
  ...
  * Authors: Kanchan Chowdhury, Venkata VamsiKrishna Meduri, Mohamed Sarwat
...
* Tabula in Action: A Sampling Middleware for Interactive Geospatial Visualization dashboards
  ...
  * Authors: Jia Yu, Kanchan Chowdhury, Mohamed Sarwat
...
* A fuzzy features based online handwritten Bangla word recognition framework
  ...
  * Authors: Kanchan Chowdhury, Lamia Alam, Shyla Sarmin, Safayet Arefin, Mohammed Moshiul Hoque
...
* Finding, Counting, and Highlighting all Triangles in Large Graphs
  ...
  * Authors: Md. Ashraf Uddin, Kanchan Chowdhury, Liton Kumar Ray
